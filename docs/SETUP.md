...
**Saving the setup screen during a removal** keeps what you typed but does not reconnect: the screen says so. The settings take effect if the removal stops — its failure path reconnects with them — or when the plugin is installed again.
